import { Currency, CurrencyAmount, MaxUint256, Percent, Fraction, ZERO } from '@wicswap/swap-sdk-core'
import invariant from 'tiny-invariant'
import { parseNumberToFraction } from '@wicswap/utils/formatFractions'
