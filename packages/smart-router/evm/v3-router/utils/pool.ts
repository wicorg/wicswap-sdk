import { SCALE, getPriceFromId } from '@wicswap/v4-sdk'
import { Currency, Pair, Price } from '@wicswap/sdk'
import { Pool as SDKV3Pool, computePoolAddress } from '@wicswap/v3-sdk'
import tryParseAmount from '@wicswap/utils/tryParseAmount'
