...
export const MIXED_ROUTE_QUOTER_ADDRESSES = {
  ...
  [ChainId.WIC_TESTNET]: '0x79d611C06FcC3a44D83f837a94C4819b0102fA3d',
...
export const V3_QUOTER_ADDRESSES = {
  ...
  [ChainId.BSC_TESTNET]: '0xfcEF8e3b1FCD87D7205d0737cBC651B0734A458d',
  ...
  [ChainId.WIC_TESTNET]: '0x488a354D6D0BA83808b98E533654f8F5967a2821',
} as const satisfies Record<ChainId, Address>
...
export const V3_TICK_LENS_ADDRESSES = {
  ...
  [ChainId.BSC_TESTNET]: '0xBAD4859F63BED16c65e58873f8C11Df1788a87b4',
  ...
  [ChainId.WIC_TESTNET]: '0x23Aa04899c8d64A4d9E796EFB09C5a98588Da73c',
} as const satisfies Record<ChainId, Address>
