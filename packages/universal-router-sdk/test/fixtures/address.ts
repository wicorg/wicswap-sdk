...
import { getPermit2Address } from '@wicswap/permit2-sdk'
import { CurrencyAmount, ERC20Token, Pair, Percent } from '@wicswap/sdk'
import { PoolType, SmartRouter, StablePool, V2Pool, V3Pool } from '@wicswap/smart-router'
import {
  DEPLOYER_ADDRESSES,
  FeeAmount,
  Pool,
