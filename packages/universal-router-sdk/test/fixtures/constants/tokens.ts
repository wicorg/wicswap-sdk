import { ERC20Token, Ether } from '@wicswap/sdk'
import { ChainId } from '@wicswap/chains'
import * as Tokens from '@wicswap/tokens'
import { zeroAddress } from 'viem'

export { WETH9 } from '@wicswap/sdk'
...
export const USDT = {
  ...Tokens.USDT,
  [ChainId.BSC_TESTNET]: new ERC20Token(ChainId.BSC_TESTNET, '0x2a4b180da0a45a5ae65f230c228de0d4de0b7057', 6, 'USDT'),
