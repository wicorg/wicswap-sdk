import { Currency, CurrencyAmount, ERC20Token, Native, Pair, TradeType, Trade as V2Trade } from '@wicswap/sdk'
import { RouteType, SmartRouter, SmartRouterTrade, StablePool, V2Pool, V3Pool } from '@wicswap/smart-router'
import { getSwapOutput } from '@wicswap/stable-swap-sdk'
import { Pool, Trade as V3Trade } from '@wicswap/v3-sdk'
